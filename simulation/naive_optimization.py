...
def perform_optimization(individuals, tissues, proportions_est):
    """
...
if __name__ == "__main__":
    ...
    mean_square_error = perform_optimization(individuals, tissues, proportions_est)  # perform optimization and return error